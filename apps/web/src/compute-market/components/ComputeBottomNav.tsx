...
import { ChartBar, Cpu, House, Newspaper, UserCircle } from '@phosphor-icons/react';
import { visibleBottomTabs } from '../capabilities';
import { activeTab } from '../routes';

const icons = { '/compute': House, '/compute/hosting': Cpu, '/compute/news': Newspaper, '/compute/rankings': ChartBar, '/compute/me': UserCircle };
