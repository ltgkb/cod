...
export function App() {
  ...
  const handleLogout = () => { void window.codDesktop?.stopGoose(); logoutCod(); setSession(null); setTasks([]); setDevices([]); setCurrentDeviceId(''); setPendingSend(null); setOverlay(null); setAuthState('signed-out'); };
