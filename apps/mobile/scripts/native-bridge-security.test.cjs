...
test('rejects a wrong capability before every exposed native action can have a side effect', () => {
  const actions = ['nativeRequest','cancelNativeRequest','openExternalUrl','copyText','setNativeColorMode','setNativeBackAvailable','loadSessionCleanupPending','loadSessionToken','saveSessionToken','clearSessionToken'];
