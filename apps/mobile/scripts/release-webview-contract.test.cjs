...
test('pins Expo DOM generation to a strict CSP and gates every native action with the main-document capability', () => {
  ...
  for (const action of ['nativeRequest','cancelNativeRequest','openExternalUrl','copyText','setNativeColorMode','setNativeTopmostUiVisible','loadSessionCleanupPending','loadSessionToken','saveSessionToken','clearSessionToken']) {
